...
I'm a passionate back-end developer with expertise in .NET, microservice architectures, and cloud-native solutions. My engineering journey is focused on building reliable, scalable, and high-performance systems for the **EV Charge Station** and **Fintech** sectors.
...
<!-- Örnek olarak popüler repolarınızı buraya ekleyin -->
 - Microservice-based backend for managing EV charging stations, OCPP 1.6 support, and real-time communication.
- Modern, secure, and scalable payment platform for fintech applications, integrating RabbitMQ, Redis, and cloud-native practices.
- [**Blog | Medium Articles**](https://medium.com/@ceydatekn85)  
  I write about .NET, microservices, and software engineering best practices.
...
- EV Charge Station Software & OCPP
- Fintech Microservices & Payment Systems
- Cloud-Native, Distributed Systems, CI/CD, Docker, Messaging Queues
- Always learning, always sharing!

---

> _"Building the future of mobility and finance, one microservice at a time."_ 🚗⚡💸
